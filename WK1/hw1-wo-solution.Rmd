...
###Answer: I would expect the sample means to be normally distributed around the population mean. So the average should approach the population mean. I would also expect the sample standard deviation to be slightly smaller than the population standard deviation (due to the N-1 correction).
